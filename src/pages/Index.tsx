...
const catalogItems = [
  ...
  { id: 22, name: "Стол «Летняя дымка»", category: "stoly", material: "Дуб, МДФ, металл · Коллекция «Мелодии лета»", price: "от 22 800 ₽", images: ["https://cdn.poehali.dev/projects/3a8fea8d-927a-442f-af67-1e18e9992c4a/bucket/5dd75758-1e55-4611-a573-e8ab73b079fd.jpg", "https://cdn.poehali.dev/projects/3a8fea8d-927a-442f-af67-1e18e9992c4a/bucket/fe2f6e26-59ff-4be4-95eb-5b31c9a8dadc.jpg", "https://cdn.poehali.dev/projects/3a8fea8d-927a-442f-af67-1e18e9992c4a/bucket/dd4bc9ba-fbea-42c5-b223-bfcfeaf1dd51.jpg"], tag: "Премиум", desc: "Стол «Летняя дымка» из коллекции «Мелодии лета». Небольшой прямоугольный столик создаёт ощущение мимолётности, как летняя дымка… Может использоваться как рабочий, так и кофейный. Премиальное качество от производителя. Гарантия до 10 лет. Отправляем по РФ любыми транспортными компаниями. Проконсультируем и подберём стол, который идеально впишется в Ваш интерьер, звоните/пишите: 8-922-81-99-288, 8-922-807-00-17, 8-932-548-53-63." },
