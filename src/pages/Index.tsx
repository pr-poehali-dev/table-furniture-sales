...
const materialData = [
  ...
  {
    icon: "Layers3",
    image: "https://cdn.poehali.dev/projects/3a8fea8d-927a-442f-af67-1e18e9992c4a/files/6af73073-8868-44f3-8da4-b0f89aec3960.jpg",
    title: "Шпон",
    short: "Шпон — это тонкие листы (срезы) натуральной древесины. Невысокая стоимость и элегантная текстура при экономичном расходе ценных пород.",
    items: ["Невысокая стоимость", "Элегантная текстура (рисунок)", "Толщина 0,5–0,7 мм — требует бережной эксплуатации"],
    details: "Шпон — это тонкие листы (срезы) натуральной древесины, которыми облицовывают более доступное основание (МДФ, ЛДСП). К положительным сторонам шпона относится невысокая стоимость по сравнению с массивом, а также элегантная и выразительная текстура (рисунок) натурального дерева. Из минусов стоит отметить толщину шпона — обычно 0,5–0,7 мм, — что со временем при неаккуратной эксплуатации может негативно сказаться на внешнем виде изделия.",
  },
];
